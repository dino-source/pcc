motorcycles = ["Yamaha", "Suzuki", "Honda", "Ducati", "Harley Davidson"]
...
first_owned = motorcycles.pop()  # pop the last one and store the popped
print(f"After popping out Indian: {motorcycles}")
print(f"The first motorcycle I owned was a {first_owned}.")

last_owned = motorcycles.pop(1)  # pop by index and store the popped
